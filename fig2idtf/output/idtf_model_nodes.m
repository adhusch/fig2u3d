function [nodes] = idtf_model_nodes(n_meshes, n_lines, n_pointsets, mesh_node_tags)
...
%   verbatim
if(nargin < 4)
    mesh_node_tags = repmat({'Mesh'},1,n_meshes);
end
...
for i=1:n_meshes
    cur_mesh_node = sprintf(mesh_node, mesh_node_tags{i}, i, i);
